...
class Classifier:
    ...
    def __init__(self, filename='hangman_words.txt'):
        self.__words = self.read(filename)
        self.classify()
    ...
    def classify(self):
        ...
        frequency_of_letter = {'a': 0.116222, 'i': 0.107077, 't': 0.098779, 'n': 0.086701, 'e': 0.082103, 's': 0.078612,
                                ...
                                'w': 8.36E-05, 'å': 1.32E-05, 'q': 6.61E-06, 'x': 0, 'z': 0}
        raw_difficulty = 0
    ...
    def readWords(self, difficulty='demonstration'):
        levels = {'demonstration': 'demonstration', 'easy': 'easy', 'intermediate': 'intermediate',
                  'difficult': 'difficult', 'expert': 'expert'}
        filename = levels[difficulty] + '.txt'
        file = None
...
""" 
for the testing of class

def main():
    c = Classifier()
    print(c.readWords('expert'))
